#!/usr/bin/python3
"""
A module with  Rectangle which doesn't do anything
"""
...
class Rectangle:
   ...
   This is  an empty Rectangle class
    ...
    def __init__(self, width=0, height=0):
        """
        Thls Checks the parameters and initializes some values
        Args:
    ...
    def width(self, value):
        """
        This Checks the parameters and set the size of the Rectangle
        Args:
    ...
    def __check_valid_width(self, width):
        """
        This Checks if the width is a valid integer
        Args:
    ...
    def __check_valid_height(self, height):
        """
        This Checks if the height is a valid integer
        Args:
    ...
    def __check_positive_value(self, value):
        """
        This Checks if the value is a positive integer
        Args:
            value (int): The number to verify
        Returns:
    ...
    def perimeter(self):
        """
        This Computes the perimeter of a Rectangle.
        Returns:
    ...
    def __draw_rectangle(self):
        """
        This Draw the Rectangle with their size
        Returns:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        This Compares the biggest or equal area value between two Rectangles
        Args:
    ...
    def __str__(self):
        """
        This Returns a string with the representation of the Rectangle.
        """
    ...
    def __repr__(self):
        """
        This Returns the representation of the Rectangle.
        """
